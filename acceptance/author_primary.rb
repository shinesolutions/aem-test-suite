...
describe author_primary do
  before :each do
    init_config
    @instance = @aem_full_set.author.author_primary
  end

  it_should_behave_like 'an disabled crxde instance'
  it_should_behave_like 'instance to deploy an artifact'
  it_should_behave_like 'deploying packages and artifacts'
  it_should_behave_like 'exporting a package'
  it_should_behave_like 'exporting packages'
