		...
		it 'should publish a message to SNS' do
			sns_client_publish = @sns_client.publish({
				subject: "Test Export Package",
                                message: "{ \"default\": \"{ 'task': 'export-package', 'stack_prefix': '#{@stack_prefix]}, 'details': { 'component': '#{@component}', 'package_group': package_group, 'package_name': package_name, 'package_filter': package_filter }}\"}",
